...
{
	?><td><a href="" class="btn btn-success" style="">DONE</a></td>
<?php } else {?>

<td><a href="manage-enquires.php?eid=<?php echo htmlentities($result->id);?>" style="background: #e74c3c;" class="btn btn-danger" onclick="return confirm('Do you really want to read')" >READ</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
