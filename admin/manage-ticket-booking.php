...
<div class="agile-grids">	
  ...
  <li class="nav-item">
    <a href="manage-bookings-pending.php" class="nav-link" >Pending</a>
						...
						<tbody>
<?php $sql = "SELECT * FROM (((tblusers INNER JOIN tblusrtktbook ON tblusers.id = tblusrtktbook.userid) INNER JOIN tblbus ON tblusrtktbook.busid = tblbus.busid) INNER JOIN tblbusroute ON tblbus.busroute = tblbusroute.brid) GROUP BY tblusrtktbook.bookid ORDER BY tblusrtktbook.bkdate ASC";
$query = $dbh -> prepare($sql);
$query->execute();
