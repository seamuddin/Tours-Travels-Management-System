...
header('location:index.php');
	...
	if(isset($_REQUEST['delete']))
	{
		...
		$sql = "DELETE FROM tblusers WHERE id = '$bid'";
...
{				?>		
						  <tr>
							...
							<td>
								...
								<a href="manage-users.php?delete=<?php echo htmlentities($result->id);?>" style="background: #e74c3c; color: white;" class="btn ">Delete</a>
							</td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
						</tbody>
