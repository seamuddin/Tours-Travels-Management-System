...
<div class="agile-grids">	
  ...
  <li class="nav-item">
    <a class="nav-link" href="manage-ticket-booking-paid.php" >Paid</a>
  </li>
  <li class="nav-item">
    <a href="manage-ticket-booking-pending.php" class="nav-link" >Pending</a>
						...
						<tbody>
<?php $sql = "SELECT * FROM (((tblusers INNER JOIN tblusrtktbook ON tblusers.id = tblusrtktbook.userid) INNER JOIN tblbus ON tblusrtktbook.busid = tblbus.busid) INNER JOIN tblbusroute ON tblbus.busroute = tblbusroute.brid) WHERE tblusrtktbook.status = 0 GROUP BY tblusrtktbook.bookid ORDER BY tblusrtktbook.bkdate ASC";
$query = $dbh -> prepare($sql);
$query->execute();
