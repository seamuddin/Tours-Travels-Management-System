		  ...
		  <h2 class="text-center text-success">
		  	  <?php
							 	...
							 	$status=intval($_GET['status']);
										...
										$date = date("Y-m-d");
										$sql18="UPDATE tblbooking set `status`= 3, `paymentdate` = '$date'  where BookingId='$bktid'";
...
?>
                	 ...
                	 <p class="p-2 text-left ml-4" style="margin-left: 10px;">Booking No: #BK 

                	 	<?php 

                	   print "  ".htmlentities($result->BookingId); ?>
