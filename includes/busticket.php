	...
	<div class="home-silder-outer owl-carousel">
		<div class="home-silder-inner">
			<div class="silder-content">
				...
				<p>
					Lorem ipsum dolor, sit amet consectetur adipisicing, elit. Maxime perferendis, dolor suscipit, doloremque unde provident exercitationem! Corporis necessitatibus.
				</p>
				<a class="silder-content-btn" href="#">View Courses</a>
			</div>
			<div class="image1">
...
{	?>		
			...
			<div class="col-lg-4 col-md-12 package-item text-center shadow-lg ">
				<div class="item-image">
					...
					<a href="#" class="item-price">$<?php echo htmlentities($result->PackagePrice);?></a>
				</div>
				<div class="item-info">
					<a href="#">
												    ...
												    <div class="col-md-7 text-center item-center">
												        ...
												        <!--selection -->
 														<div class="col-md-4">
															...
															<?php 
															$query="SELECT `busfrom` FROM `tblbusroute`";
 														...
 														<div class="col-md-4">
															...
															<?php 
															$query="SELECT `busto` FROM `tblbusroute`";
																	$result=$conn->query($query);
																	$fetch=$result->fetch_array();  
